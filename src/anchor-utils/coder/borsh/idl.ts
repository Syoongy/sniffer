...
import {
 IdlField, IdlTypeDef, IdlEnumVariant, IdlType,
} from "../../idl.js";
import logger from "../../../loader/log.js";

export default class IdlCoder {
      ...
      default: {
        ...
        if ("defined" in field.type) {
          ...
          if (filtered.length !== 1) {
            logger.warn(`[anchor-utils/coder/borsh/idl::IdlCoder] Missing: ${JSON.stringify(field)}`);
            throw new IdlError("User defined types not provided");
          }
  ...
  public static typeDefLayout(typeDef: IdlTypeDef, types: IdlTypeDef[] = [], name?: string, depth: number = 0): Layout {
