...
export default {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "userSourceTokenAccount", isMut: false, isSigner: false },
        { name: "userDestinationTokenAccount", isMut: false, isSigner: false },
        { name: "destinationTokenAccount", isMut: false, isSigner: false, isOptional: true },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "destinationMint", isMut: false, isSigner: false },
        { name: "platformFeeAccount", isMut: true, isSigner: false, isOptional: true },
        { name: "tokenLedger", isMut: false, isSigner: false },
        { name: "eventAuthority", isMut: false, isSigner: false },
        { name: "program", isMut: false, isSigner: false },
      ],
      args: [
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "programSourceTokenAccount", isMut: true, isSigner: false },
        { name: "programDestinationTokenAccount", isMut: true, isSigner: false },
        { name: "destinationTokenAccount", isMut: true, isSigner: false },
        { name: "sourceMint", isMut: false, isSigner: false },
        { name: "destinationMint", isMut: false, isSigner: false },
        { name: "platformFeeAccount", isMut: true, isSigner: false, isOptional: true },
        { name: "token2022Program", isMut: false, isSigner: false, isOptional: true },
        { name: "eventAuthority", isMut: false, isSigner: false },
        { name: "program", isMut: false, isSigner: false },
      ],
      args: [
    ...
    },
    {
      name: "setTokenLedger",
      accounts: [
        { name: "tokenLedger", isMut: true, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        { name: "tokenLedger", isMut: true, isSigner: true },
        { name: "payer", isMut: true, isSigner: true },
        { name: "systemProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        ...
        { name: "swapState", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "poolAuthority", isMut: false, isSigner: false },
        { name: "userTransferAuthority", isMut: false, isSigner: false },
        { name: "sourceTokenAccount", isMut: true, isSigner: false },
        { name: "destinationTokenAccount", isMut: true, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        { name: "swapProgram", isMut: false, isSigner: false },
        { name: "signer", isMut: false, isSigner: false },
        { name: "factoryState", isMut: false, isSigner: false },
        ...
        { name: "lastObservationState", isMut: true, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "orderPayerTokenAccount", isMut: true, isSigner: false },
        { name: "coinWallet", isMut: true, isSigner: false },
        { name: "pcWallet", isMut: true, isSigner: false },
        { name: "dexProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "rent", isMut: false, isSigner: false },
      ],
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "userAuthority", isMut: false, isSigner: false },
        { name: "inputUserAccount", isMut: true, isSigner: false },
        { name: "inputTokenAccount", isMut: true, isSigner: false },
        { name: "outputUserAccount", isMut: true, isSigner: false },
        { name: "outputTokenAccount", isMut: true, isSigner: false },
        { name: "feesTokenAccount", isMut: true, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        { name: "addDecimalsProgram", isMut: false, isSigner: false },
        { name: "wrapper", isMut: false, isSigner: false },
        { name: "wrapperMint", isMut: true, isSigner: false },
        { name: "wrapperUnderlyingTokens", isMut: true, isSigner: false },
        { name: "owner", isMut: false, isSigner: false },
        { name: "userUnderlyingTokens", isMut: true, isSigner: false },
        { name: "userWrappedTokens", isMut: true, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
      name: "tokenSwap",
      accounts: [
        { name: "tokenSwapProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "swap", isMut: false, isSigner: false },
        { name: "authority", isMut: false, isSigner: false },
        { name: "userTransferAuthority", isMut: false, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "sourceMint", isMut: false, isSigner: false },
        { name: "destinationMint", isMut: false, isSigner: false },
        { name: "sourceTokenProgram", isMut: false, isSigner: false },
        { name: "destinationTokenProgram", isMut: false, isSigner: false },
        { name: "poolTokenProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        ...
        { name: "inputUserAccount", isMut: true, isSigner: false },
        { name: "inputTokenAccount", isMut: true, isSigner: false },
        { name: "inputFeesAccount", isMut: true, isSigner: false },
        { name: "outputUserAccount", isMut: true, isSigner: false },
        { name: "outputTokenAccount", isMut: true, isSigner: false },
        { name: "outputFeesAccount", isMut: true, isSigner: false },
      ],
      args: [],
    },
    {
    ...
    },
    {
      ...
      accounts: [
        { name: "swapProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "ammId", isMut: true, isSigner: false },
        ...
        { name: "serumProgramId", isMut: false, isSigner: false },
        ...
        { name: "userSourceOwner", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        { name: "swapProgram", isMut: false, isSigner: false },
        { name: "clmmConfig", isMut: false, isSigner: false },
        { name: "clmmpool", isMut: true, isSigner: false },
        { name: "tokenA", isMut: false, isSigner: false },
        { name: "tokenB", isMut: false, isSigner: false },
        { name: "accountA", isMut: true, isSigner: false },
        { name: "accountB", isMut: true, isSigner: false },
        { name: "tokenAVault", isMut: true, isSigner: false },
        { name: "tokenBVault", isMut: true, isSigner: false },
        { name: "tickArrayMap", isMut: true, isSigner: false },
        { name: "owner", isMut: false, isSigner: false },
        { name: "partner", isMut: false, isSigner: false },
        { name: "partnerAtaA", isMut: true, isSigner: false },
        { name: "partnerAtaB", isMut: true, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        ...
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "pythAccount", isMut: false, isSigner: false },
        { name: "pythPcAccount", isMut: false, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        { name: "marinadeFinanceProgram", isMut: false, isSigner: false },
        ...
        { name: "transferFrom", isMut: true, isSigner: false },
        { name: "mintTo", isMut: true, isSigner: false },
        { name: "msolMintAuthority", isMut: false, isSigner: false },
        { name: "systemProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "userWsolTokenAccount", isMut: true, isSigner: false },
        { name: "tempWsolTokenAccount", isMut: true, isSigner: false },
        { name: "userTransferAuthority", isMut: false, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "liqPoolSolLegPda", isMut: true, isSigner: false },
        { name: "liqPoolMsolLeg", isMut: true, isSigner: false },
        { name: "treasuryMsolAccount", isMut: true, isSigner: false },
        { name: "getMsolFrom", isMut: true, isSigner: false },
        { name: "getMsolFromAuthority", isMut: false, isSigner: false },
        { name: "transferSolTo", isMut: true, isSigner: false },
        { name: "systemProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "userWsolTokenAccount", isMut: true, isSigner: false },
      ],
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "poolSigner", isMut: false, isSigner: false },
        { name: "poolMint", isMut: true, isSigner: false },
        { name: "baseTokenVault", isMut: true, isSigner: false },
        { name: "quoteTokenVault", isMut: true, isSigner: false },
        { name: "feePoolTokenAccount", isMut: true, isSigner: false },
        { name: "walletAuthority", isMut: false, isSigner: false },
        { name: "userBaseTokenAccount", isMut: true, isSigner: false },
        { name: "userQuoteTokenAccount", isMut: true, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    ...
    },
    {
      ...
      accounts: [
        { name: "swapProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "tokenAuthority", isMut: false, isSigner: false },
        { name: "whirlpool", isMut: true, isSigner: false },
        { name: "tokenOwnerAccountA", isMut: true, isSigner: false },
        { name: "tokenVaultA", isMut: true, isSigner: false },
        { name: "tokenOwnerAccountB", isMut: true, isSigner: false },
        { name: "tokenVaultB", isMut: true, isSigner: false },
        { name: "tickArray0", isMut: true, isSigner: false },
        { name: "tickArray1", isMut: true, isSigner: false },
        { name: "tickArray2", isMut: true, isSigner: false },
        {
          name: "oracle",
          isMut: false,
          isSigner: false,
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "tickmap", isMut: true, isSigner: false },
        { name: "accountX", isMut: true, isSigner: false },
        { name: "accountY", isMut: true, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        { name: "swapProgram", isMut: false, isSigner: false },
        { name: "controller", isMut: false, isSigner: false },
        { name: "pair", isMut: true, isSigner: false },
        { name: "sslIn", isMut: true, isSigner: false },
        { name: "sslOut", isMut: true, isSigner: false },
        { name: "liabilityVaultIn", isMut: true, isSigner: false },
        { name: "swappedLiabilityVaultIn", isMut: true, isSigner: false },
        { name: "liabilityVaultOut", isMut: true, isSigner: false },
        { name: "swappedLiabilityVaultOut", isMut: true, isSigner: false },
        { name: "userInAta", isMut: true, isSigner: false },
        { name: "userOutAta", isMut: true, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "swapInfo", isMut: true, isSigner: false },
        { name: "userSourceToken", isMut: true, isSigner: false },
        { name: "userDestinationToken", isMut: true, isSigner: false },
        { name: "swapSourceToken", isMut: true, isSigner: false },
        { name: "swapDestinationToken", isMut: true, isSigner: false },
        { name: "deltafiUser", isMut: true, isSigner: false },
        { name: "adminDestinationToken", isMut: true, isSigner: false },
        { name: "pythPriceBase", isMut: false, isSigner: false },
        { name: "pythPriceQuote", isMut: false, isSigner: false },
        { name: "userAuthority", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        ...
        { name: "pool", isMut: true, isSigner: false },
        { name: "taxMan", isMut: true, isSigner: false },
        { name: "bidMint", isMut: false, isSigner: false },
        { name: "treasurer", isMut: false, isSigner: false },
        { name: "srcTreasury", isMut: true, isSigner: false },
        { name: "srcAssociatedTokenAccount", isMut: true, isSigner: false },
        { name: "askMint", isMut: false, isSigner: false },
        { name: "dstTreasury", isMut: true, isSigner: false },
        { name: "dstAssociatedTokenAccount", isMut: true, isSigner: false },
        { name: "dstTokenAccountTaxman", isMut: true, isSigner: false },
        { name: "systemProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "poolXAccount", isMut: true, isSigner: false },
        { name: "poolYAccount", isMut: true, isSigner: false },
        { name: "swapperXAccount", isMut: true, isSigner: false },
        { name: "swapperYAccount", isMut: true, isSigner: false },
        { name: "swapper", isMut: true, isSigner: false },
        { name: "referrerXAccount", isMut: true, isSigner: false },
        { name: "referrerYAccount", isMut: true, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "market", isMut: true, isSigner: false },
        { name: "eventQueue", isMut: true, isSigner: false },
        { name: "dexUser", isMut: false, isSigner: false },
        { name: "marketUser", isMut: true, isSigner: false },
        { name: "bids", isMut: true, isSigner: false },
        { name: "asks", isMut: true, isSigner: false },
        { name: "t0Vault", isMut: true, isSigner: false },
        { name: "t1Vault", isMut: true, isSigner: false },
        { name: "t0User", isMut: true, isSigner: false },
        { name: "t1User", isMut: true, isSigner: false },
        { name: "master", isMut: false, isSigner: false },
        { name: "signer", isMut: true, isSigner: false },
        { name: "systemProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
        { name: "logger", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
    ...
    },
    {
      ...
      accounts: [
        { name: "swapProgram", isMut: false, isSigner: false },
        { name: "logAuthority", isMut: false, isSigner: false },
        { name: "market", isMut: true, isSigner: false },
        { name: "trader", isMut: false, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "pdaFromTokenAccount", isMut: true, isSigner: false },
        { name: "buyerFromTokenAccount", isMut: true, isSigner: false },
        { name: "pdaToTokenAccount", isMut: true, isSigner: false },
        { name: "buyerToTokenAccount", isMut: true, isSigner: false },
        { name: "swapFeeAccount", isMut: true, isSigner: false },
        { name: "hostFeeAccount", isMut: true, isSigner: false },
        { name: "managerFeeAccount", isMut: true, isSigner: false },
        { name: "tokenInfo", isMut: false, isSigner: false },
        { name: "prismData", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    {
      ...
      accounts: [
        { name: "swapProgram", isMut: false, isSigner: false },
        { name: "treasuryManagement", isMut: false, isSigner: false },
        { name: "treasuryMint", isMut: false, isSigner: false },
        { name: "supplyMint", isMut: true, isSigner: false },
        { name: "treasury", isMut: true, isSigner: false },
        { name: "circuitBreaker", isMut: true, isSigner: false },
        { name: "from", isMut: true, isSigner: false },
        { name: "to", isMut: true, isSigner: false },
        { name: "owner", isMut: false, isSigner: false },
        { name: "circuitBreakerProgram", isMut: false, isSigner: false },
        { name: "tokenProgram", isMut: false, isSigner: false },
      ],
      args: [],
    },
    ...
    { name: "Side", type: { kind: "enum", variants: [{ name: "Bid" }, { name: "Ask" }] } },
    {
      ...
      type: {
        ...
        variants: [
          ...
          { name: "Mercurial" },
          { name: "Cykura" },
          { name: "Serum", fields: [{ name: "side", type: { defined: "Side" } }] },
          { name: "MarinadeDeposit" },
          { name: "MarinadeUnstake" },
          { name: "Aldrin", fields: [{ name: "side", type: { defined: "Side" } }] },
          { name: "AldrinV2", fields: [{ name: "side", type: { defined: "Side" } }] },
          ...
          { name: "Dradex", fields: [{ name: "side", type: { defined: "Side" } }] },
          { name: "LifinityV2" },
          { name: "RaydiumClmm" },
          { name: "Openbook", fields: [{ name: "side", type: { defined: "Side" } }] },
          { name: "Phoenix", fields: [{ name: "side", type: { defined: "Side" } }] },
          {
            name: "Symmetry",
            fields: [
          ...
          { name: "StakeDexSwapViaStake", fields: [{ name: "bridge_stake_seed", type: "u32" }] },
        ],
      },
    },
  ],
  ...
  errors: [
    ...
    { code: 6001, name: "SlippageToleranceExceeded", msg: "Slippage tolerance exceeded" },
    { code: 6002, name: "InvalidCalculation", msg: "Invalid calculation" },
    { code: 6003, name: "MissingPlatformFeeAccount", msg: "Missing platform fee account" },
    { code: 6004, name: "InvalidSlippage", msg: "Invalid slippage" },
    { code: 6005, name: "NotEnoughPercent", msg: "Not enough percent to 100" },
    { code: 6006, name: "InvalidInputIndex", msg: "Token input index is invalid" },
    { code: 6007, name: "InvalidOutputIndex", msg: "Token output index is invalid" },
    { code: 6008, name: "NotEnoughAccountKeys", msg: "Not Enough Account keys" },
    { code: 6009, name: "NonZeroMinimumOutAmountNotSupported", msg: "Non zero minimum out amount not supported" },
    { code: 6010, name: "InvalidRoutePlan", msg: "Invalid route plan" },
    { code: 6011, name: "InvalidReferralAuthority", msg: "Invalid referral authority" },
    { code: 6012, name: "LedgerTokenAccountDoesNotMatch", msg: "Token account doesn't match the ledger" },
    { code: 6013, name: "InvalidTokenLedger", msg: "Invalid token ledger" },
    { code: 6014, name: "IncorrectTokenProgramID", msg: "Token program ID is invalid" },
    { code: 6015, name: "TokenProgramNotProvided", msg: "Token program not provided" },
  ],
} as Idl;
